...
const AllpropertyList = () => {
    ...
    const getPropertyList = async () => {
        ...
        // .then(res => console.log(res))     //paste the propperty url here
    ...
    const searchHandel = async (event) => {
        ...
        if (key) {
            let result = await fetch(`https://realestatecatalog.onrender.com/search/${key}`) // paste the search property url by key
    ...
    const updateStatus = async (id) => {
        ...
        let status = "Unsold"
        let result = await fetch(`//https://realestatecatalog.onrender.com/properties/${id}`, {   //paste the id url here
            method: "put",
...
// https://realestatecatalog.onrender.com/properties



// https://realestatecatalog.onrender.com/search/${key}

//https://realestatecatalog.onrender.com/properties/${id}